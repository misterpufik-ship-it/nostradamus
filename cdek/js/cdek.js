...
function initCdekTool(root) {
  ...
  const printBtn = root.querySelector("#cdek-print");
  ...
  function pickFile(file) {
    ...
    currentFile = file;
    resetOutput();
    setStatus(`Выбран файл: ${file.name}. Нажмите «Отсортировать».`, "info");
  ...
  printBtn.addEventListener("click", () => {
    ...
    printBytes(sortedBytes);
  });
}

document.addEventListener("DOMContentLoaded", () => {
  initCdekTool(document.querySelector("#cdek-app"));
});
